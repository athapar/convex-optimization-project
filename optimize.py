...
sent to the supplier in the code, using an extra parameter in the retailer function. The program currently uses 5 months of data (can take more- will adjust parameters automatically)
as calculations for sensitivity analysis would take too long to calculate using 6 months or more. """
